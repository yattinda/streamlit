...
st.title('住みやすい街検索')
st.write('### 衛星データを活用して街の住みやすさをお届けします')
...
if run:
    ...
    content_air = np.array(lord("data/NO2_Japan.csv"))
    ...
    st.write("## 植生スコア : {}　NO2スコア : {}".format(nearrest_coor_ndvi[2], nearrest_coor_air[2]-1))
    st.bar_chart({"スコア": [nearrest_coor_ndvi[2], nearrest_coor_air[2]]})
